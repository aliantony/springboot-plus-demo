...
public class MockItoTest {
    ...
    public void argumentMatchersTest(){
        ...
        ArgumentMatcher<List> matcher = (e) -> e.size() == 2;
        //argThat(Matches<T> matcher)方法用来应用自定义的规则，可以传入任何实现Matcher接口的实现类。
        when(mock.addAll(argThat(matcher))).thenReturn(true);

        mock.addAll(Arrays.asList("one","two","three"));
        //IsListofTwoElements用来匹配size为2的List，因为例子传入List为三个元素，所以此时将失败。
        verify(mock).addAll(argThat(matcher));
    }
    ...
    public void with_unspecified_arguments(){
        ...
        ArgumentMatcher<Integer> ma = (e) -> e ==1 || e==2;
        System.out.println(ma.matches(1));
    }
